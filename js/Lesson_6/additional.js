...
// return str.split("");
// }
// let cStr = cutString("правосуддя", 2);
// console.log(cStr);

// - Напишіть функцію delete_characters(str, length), яка повертає підрядок, що складається із зазначеної кількості символів.
//     let str = 'Каждый охотник желает знать';
// let charactersDelete = (string, leng) => {
//     return string.substring(0, leng);
// }
// console.log(charactersDelete(str, 10));
...
//     return str.split(" ").map(value => `${value[0].toUpperCase()}${value.slice(1)}`);
// }
// console.log(firstToUpperCase("як аргумент і перетворює регістр першого"));
